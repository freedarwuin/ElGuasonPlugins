...
public class DancerPlugin extends Plugin
{
	...
	@Inject
	private com.piggyplugins.dancer.DancerConfig config;
	...
	@Provides
	com.piggyplugins.dancer.DancerConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(com.piggyplugins.dancer.DancerConfig.class);
	}
