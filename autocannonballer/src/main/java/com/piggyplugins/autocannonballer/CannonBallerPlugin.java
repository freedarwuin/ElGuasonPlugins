...
public class CannonBallerPlugin extends Plugin
{
	...
	@Inject
	private com.piggyplugins.autocannonballer.CannonBallerConfig config;
	...
	@Provides
	com.piggyplugins.autocannonballer.CannonBallerConfig provideConfig(ConfigManager configManager)
	{
		return configManager.getConfig(com.piggyplugins.autocannonballer.CannonBallerConfig.class);
	}
