...
import com.ozplugins.AutoNMZ.util.Utils;
...
import static com.ozplugins.AutoNMZ.AutoNMZState.*;
...
public class AutoNMZPlugin extends Plugin {
    ...
    private void onGameTick(GameTick tick) {
        ...
        if (client.getGameState() != GameState.LOGGED_IN) { //This even needed?
            forceTab = false;
            return;
        }
